...
{
       0,    55,    55,    62,    72,    76,    77,    78,    82,    85,
      91,    92,    96,   104,   105,   109,   115,   119,   122,   128,
     134,   144,   148,   158,   162,   163,   164,   165,   166,   167,
     171,   172,   176,   179,   185,   191,   194,   200,   203,   207,
     208,   214,   217,   221,   222,   223,   224,   225,   226,   230,
     233,   237,   238,   242,   245,   249,   250,   254,   255,   256,
     257,   261,   267,   268,   272,   278
};
#endif
...
int main(int argc, char *argv[]) {
    ...
    if (parse_result == 0 && syntax_error_count == 0) { 
        ...
        if (semantic_error_count == 0) {
            printf("\nIniciando Geração de Código Intermediário (Quádruplas)...\n");
            generate_code(ast_root);
            imprimirQuadruplas();
            salvarQuadruplas("saida.quad");
